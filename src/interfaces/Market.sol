...
interface Market {
    ...
    event EarningsAccumulatorSmoothFactorSet(
        uint256 earningsAccumulatorSmoothFactor
    );
    event FixedEarningsUpdate(
        uint256 timestamp,
        uint256 indexed maturity,
    ...
    function borrow(
        ...
        address receiver,
        address borrower
    ) external returns (uint256 borrowShares);
    ...
    function fixedBorrowPositions(
        uint256,
        address
    ) external view returns (uint256 principal, uint256 fee);

    function fixedDepositPositions(
        uint256,
        address
    ) external view returns (uint256 principal, uint256 fee);

    function fixedPoolBalance(
        uint256 maturity
    ) external view returns (uint256, uint256);

    function fixedPoolBorrowed(
        uint256 maturity
    ...
    function refund(
        ...
        address borrower
    ) external returns (uint256 assets, uint256 actualShares);
    ...
    function repay(
        uint256 assets,
        address borrower
    ) external returns (uint256 actualRepay, uint256 borrowShares);
